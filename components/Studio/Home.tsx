    ...
    <div className="max-w-4xl mx-auto space-y-12 py-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <div key={i} className="glass-effect p-8 rounded-[2.5rem] border border-slate-800 hover:border-emerald-500/30 transition-all group">
      ...
      <div className="glass-effect rounded-[3rem] p-10 overflow-hidden relative border border-slate-800">
        <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-500/5 blur-[100px] -z-10" />
        <div className="relative z-10 space-y-6">
          <h2 className="text-2xl font-bold">O que podes ver aqui?</h2>
